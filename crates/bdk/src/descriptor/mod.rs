...
use bitcoin::{PublicKey, key::XOnlyPublicKey, secp256k1};
...
pub(crate) trait DescriptorMeta {
    ...
    fn get_extended_keys(&self) -> Result<Vec<DescriptorXKey<Xpub>>, DescriptorError>;
...
mod test {
    ...
    fn test_to_wallet_descriptor_fixup_networks() {
        use crate::keys::{IntoDescriptorKey, any_network};
