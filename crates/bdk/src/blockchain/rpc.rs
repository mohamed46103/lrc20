...
use bitcoincore_rpc::jsonrpc::serde_json::{Value, json};
use bitcoincore_rpc::{Auth as RpcAuth, jsonrpc};
...
impl ConfigurableBlockchain for RpcBlockchain {
    ...
    fn from_config(config: &Self::Config) -> Result<Self, Error> {
        ...
        let network = match blockchain_info.chain.to_string().as_str() {
