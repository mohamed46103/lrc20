...
use crate::{MultisigReceiptProof, Receipt};

impl Encodable for MultisigReceiptProof {
...
impl Decodable for MultisigReceiptProof {
    fn consensus_decode<R: io::Read + ?Sized>(
        ...
        Ok(MultisigReceiptProof::new(receipt, inner_keys, m))
    }
}
