...
use bitcoin::{
    Amount, ScriptBuf, TxIn, TxOut, Witness, hashes::hash160, key::XOnlyPublicKey,
    secp256k1::PublicKey,
};
use once_cell::sync::Lazy;

use crate::TokenPubkey;
...
fn test_proof_simple_checks() {
    ...
    let proof = LightningHtlcProof::new(receipt, data);
